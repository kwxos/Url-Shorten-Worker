...
let index_html = "https://kwxos.github.io/Url-Shorten-Worker/" + config.theme + "/index.html"
let result_html = "https://kwxos.github.io/Url-Shorten-Worker/" + config.theme + "/result.html"
...
<body>
  <div class="container">
    <h1>404</h1>
    <p>此链接未找到（404 Not Found.）</p>
    <p>或者url已经被销毁,请重新生成</p>
    <p><a href="https://blog.loadke.tech" target="_self">访问我的博客</a></p>
  </div>
</body>
</html>
`
  ...
  async function handleRequest(request) {
    ...
    if (!path) {
      return Response.redirect("https://blog.loadke.tech", 302)
